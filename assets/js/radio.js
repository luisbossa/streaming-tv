const shows = [
  ...
  {
    title: "ReggaeWorldCR.com",
    host: "Música reagge",
    category: "Reagge",
    listeners: "4.1K",
    desc: "New Music, Riddims 2026, New Riddims, Dancehall Riddims 2026, Reggae Riddims 2026, All New Riddims 2026.",
    img: "/assets/images/radio-imgs/reggaeworld.png",
    cover: "/assets/images/radio-imgs/reggaeworld-cover.png",
    src: "https://usa18.fastcast4u.com/proxy/frortega?mp=/1",
  },
  {
    title: "Reggae Místico Radio",
    host: "Música reagge de CR",
    category: "Reagge",
    listeners: "3.8K",
    desc: "Espacio radiofónico virtual que opera desde Costa Rica para los amantes de la música reggae en el mundo entero, aportando armonía y buena onda.",
    img: "/assets/images/radio-imgs/mistico.webp",
    cover: "/assets/images/radio-imgs/mistico-cover.webp",
